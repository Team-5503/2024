...
public class Climber extends Subsystem {
  ...
  private Climber() {
    ...
    mLeftClimberMotor.enableSoftLimit(SoftLimitDirection.kForward, true);
    mLeftClimberMotor.enableSoftLimit(SoftLimitDirection.kReverse, true);
    mLeftClimberMotor.setSoftLimit(SoftLimitDirection.kForward, 0);
    mLeftClimberMotor.setSoftLimit(SoftLimitDirection.kReverse, -305);

    mRightClimberMotor = new CANSparkMax(Constants.kClimberRightMotorId, MotorType.kBrushless);
    mRightClimberMotor.enableSoftLimit(SoftLimitDirection.kForward, true);
    mRightClimberMotor.enableSoftLimit(SoftLimitDirection.kReverse, true);
    mRightClimberMotor.setSoftLimit(SoftLimitDirection.kForward, 0);
    mRightClimberMotor.setSoftLimit(SoftLimitDirection.kReverse, -305);
    ...
    mLeftClimberMotor.setSmartCurrentLimit(60);
    mRightClimberMotor.setSmartCurrentLimit(60);
  }
