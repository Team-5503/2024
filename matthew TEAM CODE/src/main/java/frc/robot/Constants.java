...
public class Constants {
  ...
  public static class Intake {
    ...
    public static final double k_pivotAngleGround = 20;
    public static final double k_pivotAngleSource = 115;
    public static final double k_pivotAngleAmp = k_pivotAngleSource;
    public static final double k_pivotAngleStow = 208;
  ...
  public static final int kShooterRightMotorId = 15;
  ...
  // Climber
  public static final int kClimberLeftMotorId = 12;
  public static final int kClimberRightMotorId = 13;
  public static final double kClimberClimbSpeed = 1300.0; // RPM
  public static final double kClimberReleaseSpeed = -1300.0; // RPM
