...
public class DriverController extends FilteredController {
  ...
  public boolean getWantsClimb() {
    return this.getHatUp();
  }

  public boolean getWantsRelease() {
    return this.getHatDown();
  }

  public boolean getWantsShooter() {
    return this.getRawButton(5);
  }

  public boolean getWantsAmp() {
    return this.getRawAxis(2) > k_triggerActivationThreshold;
  }
